...
#define AppName "Animarr"
#define AppPublisher "Team Animarr"
...
OutputBaseFilename=Animarr.{#BranchName}.{#BuildNumber}.{#Runtime}-installer
...
Filename: "{app}\Sonarr.exe"; Description: "Open Animarr Web UI"; Flags: postinstall skipifsilent nowait; Tasks: windowsService;
Filename: "{app}\Sonarr.exe"; Description: "Start Animarr"; Flags: postinstall skipifsilent nowait; Tasks: startupShortcut none;
