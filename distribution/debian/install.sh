#!/bin/bash
### Description: Animarr .NET Debian install
...
### Version v1.0.0 2023-12-29 - StevieTV - adapted from servarr script for Animarr installs
...
echo "Running Animarr Install Script - Version [$scriptversion] as of [$scriptdate]"
...
# get arch
dlbase="https://services.animarr.tv/v1/download/$branch/latest?version=4&os=linux"
case "$ARCH" in
