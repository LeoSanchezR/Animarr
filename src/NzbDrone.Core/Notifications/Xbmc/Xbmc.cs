...
namespace NzbDrone.Core.Notifications.Xbmc
{
    public class Xbmc : NotificationBase<XbmcSettings>
    {
        ...
        {
            const string header = "Animarr - Grabbed";
        ...
        {
            const string header = "Animarr - Downloaded";
        ...
        {
            const string header = "Animarr - Imported";
        ...
        {
            const string header = "Animarr - Deleted";
        ...
        {
            const string header = "Animarr - Added";
